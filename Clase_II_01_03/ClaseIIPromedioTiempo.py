...
import ClaseIIPromedioTiempo_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class ClaseIIPromedioTiempo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ClaseIIPromedioTiempo")
...
def main(top_block_cls=ClaseIIPromedioTiempo, options=None):
